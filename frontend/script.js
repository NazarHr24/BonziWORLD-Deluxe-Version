        ...
        function a(b, c) {
			...
			if (authlevel >= 3) {
			    ...
			    menu.items.mod.items.pope = {
                                name: "Popeify",
                                  callback: function () {
                                    socket.emit("command", { list: ["pope", d.id] });
                                }
			    }
                        }
                        //End of menu
    ...
    BonziData = {
        ...
        event_list_fact_mid: [
            ...
            [{
                ...
                type: "text",
                text: "Fun Fact: the fune are bad owner (cuz he is gorefag, pornfag, vorefag, and etc) also bonzi.lol suck"
            }, {
                type: "anim",
                anim: "earth_back",
                ticks: 15
            ...
            [{
                ...
                type: "text",
                text: "Well, if you don't know the answer, i'll tell you. It's Swag FRENZY."
            }],
            [{
                type: "text",
                text: "Did you know that Assmad Is bless beggar, 9 Years old, and underage kiddies"
            }, {
                type: "anim",
                anim: "grin_fwd",
                ticks: 15
